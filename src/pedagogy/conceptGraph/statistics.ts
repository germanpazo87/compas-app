...
export const statisticsConceptGraph: ConceptGraph = {
  ...
  descriptive_statistics: {
    ...
    difficulty: 1,
    prerequisites: [],
    relatedConcepts: ["mean", "median", "mode", "frequency_absolute"],
    tags: ["descriptive", "conceptual", "overview"],
  },
  ...
  dispersion: {
    ...
    relatedConcepts: ["variance", "standard_deviation", "range"],
    tags: ["descriptive", "measures", "advanced"],
  },
};